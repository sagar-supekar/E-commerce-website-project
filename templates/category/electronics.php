            ...
            echo "
                <div class='product-item out-of-stock'>
                    ...
                    <div class='product-details'>
                        ...
                        <div class='product-actions disabled' id='product-button'>
                            <button class='btn btn-buy-now' id='buy-now' disabled>Buy Now</button>
                            <button class='btn btn-warning' disabled>To Cart</button>
                        </div>
                    </div>
                </div>
            ";
