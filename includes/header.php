...
<body>
    ...
    <nav class="navbar sticky-top navbar-expand-lg navbar-light bg-dark">
        <div class="container-fluid">
            ...
            <a class="navbar-brand" href="#">EzyBuy</a>
            ...
            <div class="collapse navbar-collapse justify-content-end" id="navbarNav">
                ...
                <a class="nav-link d-flex align-items-center me-3" href="<?php echo $user_id ? '#' : '/E-commerce website/templates/login.php'; ?>">
                    ...
                    <?php if ($username): ?>
                        <div class="dropdown mx-3">
                            <button class="btn btn-secondary dropdown-toggle d-flex align-items-center" type="button" id="profileDropdown" data-bs-toggle="dropdown" aria-expanded="true">
